...
//cadastro de usuarios no banco
    ...
    private void adicionar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty()) || (txtUsuLogin.getText().isEmpty()) || (txtUsuSenha.getText().isEmpty())) {
                ...
                //if abaixo é para confirmar a inserção dos dados
                int adicionado = pst.executeUpdate();
                //
                if (adicionado > 0) {
                    JOptionPane.showInternalMessageDialog(null, "Usuário adicionado com sucesso");
    ...
    private void alterar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty()) || (txtUsuLogin.getText().isEmpty()) || (txtUsuSenha.getText().isEmpty())) {
                ...
                //
                if (adicionado > 0) {
                    JOptionPane.showInternalMessageDialog(null, "Dados do Usuário alterados com sucesso");
                    txtUsuId.setText(null);
                    txtUsuNome.setText(null);
                    txtUsuFone.setText(null);
                    txtUsuLogin.setText(null);
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/topduo.png"))); // NOI18N

        btnUsuDelete.setBackground(java.awt.SystemColor.activeCaption);
        btnUsuDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/delete.png"))); // NOI18N
        ...
        btnUsuCreate.setBackground(new java.awt.Color(0, 153, 204));
        btnUsuCreate.setForeground(new java.awt.Color(0, 0, 204));
        btnUsuCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/create.png"))); // NOI18N
        ...
        btnUsuRead.setBackground(java.awt.SystemColor.activeCaption);
        btnUsuRead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/read.png"))); // NOI18N
        ...
        btnUsuUpdate.setBackground(new java.awt.Color(0, 153, 204));
        btnUsuUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/update.png"))); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addComponent(txtUsuFone, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
