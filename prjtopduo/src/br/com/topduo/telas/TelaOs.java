...
public class TelaOs extends javax.swing.JInternalFrame {
    ...
    private void emitir_os() {
        ...
        try {
            ...
            if ((txtCliId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty()) || (cboOsSit.getSelectedItem().equals(" "))) {
                JOptionPane.showMessageDialog(null, "Preencha todos os campos Obrigátórios");
            } else {
                int adicionado = pst.executeUpdate();
                if (adicionado > 0) {
                    JOptionPane.showInternalMessageDialog(null, "Ordem de Serviço emitida com sucesso");
    ...
    private void pesquisar_os() {
        ...
        String sql = "select os,date_format(data_os,'%d/%m/%Y - %H:%i'),tipo,situacao,equipamento,defeito,servico,valor,idcli from tbos where os= " + num_os;
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
    ...
    private void alterar_os() {
        ...
        try {
            ...
            if ((txtCliId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty()) || (cboOsSit.getSelectedItem().equals(" "))) {
                ...
                int adicionado = pst.executeUpdate();
                if (adicionado > 0) {
                    JOptionPane.showInternalMessageDialog(null, "Ordem de Serviço alteradan com sucesso");
                    limpar();
    ...
    private void excluir_os() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                if (apagado > 0) {
                    JOptionPane.showMessageDialog(null, "Ordem de Serviço excluída com sucesson");
                    limpar();
                }
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, e);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(568, 511));
        ...
        txtData.setFont(new java.awt.Font("Segoe UI", 0, 9)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/pesquisar.png"))); // NOI18N
        ...
        btnOsImprimir.setBackground(new java.awt.Color(0, 153, 204));
        btnOsImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/impressora.png"))); // NOI18N
        btnOsImprimir.setToolTipText("Deletar");
        btnOsImprimir.setBorderPainted(false);
        ...
        btnOsAdicionar.setBackground(new java.awt.Color(0, 153, 204));
        btnOsAdicionar.setForeground(new java.awt.Color(0, 0, 204));
        btnOsAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/create.png"))); // NOI18N
        btnOsAdicionar.setToolTipText("Adicionar");
        btnOsAdicionar.setBorderPainted(false);
        ...
        btnOsPesquisar.setBackground(java.awt.SystemColor.activeCaption);
        btnOsPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/read.png"))); // NOI18N
        btnOsPesquisar.setToolTipText("Consultar");
        btnOsPesquisar.setBorderPainted(false);
        ...
        btnOsAlterar.setBackground(new java.awt.Color(0, 153, 204));
        btnOsAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/update.png"))); // NOI18N
        btnOsAlterar.setToolTipText("Alterar");
        btnOsAlterar.setBorderPainted(false);
        ...
        btnOsExcluir.setBackground(java.awt.SystemColor.activeCaption);
        btnOsExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/topduo/icones/delete.png"))); // NOI18N
        btnOsExcluir.setToolTipText("Deletar");
        btnOsExcluir.setBorderPainted(false);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtOsValor, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(txtOsTec, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(txtOsEquip, javax.swing.GroupLayout.DEFAULT_SIZE, 444, Short.MAX_VALUE)
                                        .addComponent(txtOsDef))
                                    .addComponent(txtOsServ, javax.swing.GroupLayout.PREFERRED_SIZE, 441, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(35, 35, 35)
                                .addComponent(btnOsAdicionar, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnOsAdicionar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
